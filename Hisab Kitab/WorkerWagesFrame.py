...
class Database:
    def __init__(self):
        self.conn = mysql.connector.connect(
            ...
            user='root',
            password='root123',
            database='dailywages sunday',  # Update this to your actual database name
        )
...
class WorkerWagesFrame(tk.Frame):
    ...
    def setup_ui(self):
        ...
        self.name_entry = tk.Entry(input_frame, width=60)  # Increased width
        self.date_entry = DateEntry(input_frame, background='darkblue', foreground='white', borderwidth=2, date_pattern='yyyy-mm-dd', width=40)  # Increased width
        self.hours_work_entry = tk.Entry(input_frame, width=40)  # Increased width
        self.wage_rate_entry = tk.Entry(input_frame, width=40)  # Increased width
        self.description_entry = tk.Entry(input_frame, width=60)  # Increased width
        ...
        self.filter_entry = tk.Entry(filter_frame, width=30)  # Increased width for filter entry
