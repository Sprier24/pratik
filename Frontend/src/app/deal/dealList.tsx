...
import { Button, Pagination, Selection, User } from "@heroui/react";
...
export const columns = [
    ...
    { name: "Deal Date", uid: "date", sortable: true },
...
export default function Deallist() {
    ...
    return (
        ...
        >
            ...
            <TableBody emptyContent={"No Deal Available"} items={sortedItems}>
                {(item) => (
