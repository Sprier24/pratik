...
export default function CalendarPage() {
  ...
  const calendars = [
    ...
    { id: 3, name: 'Social', color: 'bg-yellow-500' },
  ];
  ...
  const renderCalendarDays = () => {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      days.push(
        <div
          key={day}
          className={`p-2 border border-gray-200 ${isToday ? 'bg-blue-100' : ''}`}
        >
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex space-x-2">
          <button
            ...
            className="bg-gray-200 p-2 rounded hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400"
          >
            <FaChevronLeft />
          </button>
          <button
...
const EventModal = ({ event, onSave, onClose, calendars }) => {
