                    ...
                    <Card className="border border-gray-300 shadow-md rounded-lg">
                        <CardContent className="p-6 space-y-4">
                            ...
                            <div className="flex flex-col sm:flex-row items-center space-x-4">
                                <label className="text-sm font-medium w-full sm:w-20">To</label>
                                <Input
                                    type="email"
                            ...
                            <div className="flex flex-col sm:flex-row items-center space-x-4">
                                <label className="text-sm font-medium w-full sm:w-20">Subject</label>
                                <Input
                                    type="text"
                            ...
                            <div className="border border-gray-300 rounded-md h-60 p-2 overflow-y-auto" contentEditable ref={messageRef} />
