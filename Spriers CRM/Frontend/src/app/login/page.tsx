  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      <div className="flex items-center justify-center">
        ...
        <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-8 md:p-8 bg-white dark:bg-black border border-gray-300 dark:border-gray-700 shadow-lg shadow-gray-500">
          {isForgotPassword ? (
            emailSent ? (
