...
const LoginScreen = () => {
    ...
    // Frontend-only session check - No backend calls needed
    useEffect(() => {
        const checkSession = async () => {
            try {
                ...
                if (userDataString) {
                    ...
                    // Simple check: if user data exists and has required fields
                    if (userData && userData.email && userData.id) {
                        console.log('User session found, redirecting...');
                        
                        // Use replace to clear navigation stack completely
    ...
    if (isCheckingSession) {
        return (
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#fff' }}>
                ...
                <Text style={{ marginTop: 10, color: '#666' }}>Checking session...</Text>
            </View>
        );
    }
    ...
    const handleLogin = async () => {
        if (email === '' || password === '') {
            ...
            try {
                ...
                // CRITICAL: Use replace instead of push to clear navigation history
