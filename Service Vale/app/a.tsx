...
//       // Current month commissions - use stored commission value
...
//       // Use stored commission values instead of calculating
...
//       // Map commission items using stored commission
...
//       // PAYMENTS FETCHING (without pagination)
//       // Fetch ALL payments (using both engineerId and engineerName for compatibility)
...
//       // Fetch current month payments for summary
...
//       // Merge new data with existing (for commissions only - payments are complete)
//       const newTransactions = {
//         commissions: isLoadMore
//           ? [...transactions.commissions, ...commissionSections]
//           : commissionSections,
//         payments: paymentSections // Always contains all payments
//       };
...
//       // Update pagination info (based on commissions only)
//       setTotalPages(Math.ceil(allCommissionsResponse.total / itemsPerPage));
...
//     const totalPayments = transactions.payments.reduce((sum: number, section: SectionData) =>
//       sum + section.data.reduce((sectionSum: number, item: TransactionItem) =>
//         sectionSum + item.amount, 0), 0);
...
// //   const calculateTotalMonthlyCommission = (): number => {
// //     return filteredTransactions.commissions.reduce((sum, section) =>
// //       sum + (section.totalAmount || 0), 0);
// //   };
