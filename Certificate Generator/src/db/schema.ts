...
export const companies = sqliteTable('companies', {
  ...
  export const certificates = sqliteTable('certificates', {
    ...
    observations: text('observations', { mode: 'json' }).$type<Array<{
      gas: string;
      before: string;
      after: string;
    }>>().notNull(),
  ...
  export const services = sqliteTable('services', {
    ...
    makeModelNumberoftheInstrumentQuantity: text('make_model_number_of_the_instrument_quantity').notNull(),
    serialNumberoftheInstrumentCalibratedOK: text('serial_number_of_the_instrument_calibrated_ok').notNull(),
